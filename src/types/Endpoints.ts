...
export function endpointsDefault(): Endpoints {
   // TODO: Emulators
    ...
    return {
            carAPIURL: "https://europe-west1-murray-apps.cloudfunctions.net/carapi/v1/booking",
            deskAPIURL: "https://europe-west1-murray-apps.cloudfunctions.net/deskapi/v1/booking",
